...
<body>
<div class="tab">
 <a href="doctorhome"> <button class="tablinks" onclick="openCity(event, 'MyProfile')" >MyProfile</button></a>
  <a href="${pageContext.servletContext.contextPath}/doctor/viewDoctorRequests"><button class="tablinks" onclick="openCity(event, 'requests')" id="defaultOpen">Requests</button></a>
...
<div id="requests" class="tabcontent">
 ...
 <tr>
   ...
   <tr>
    ...
    <td><a href="${accept}">Accept</a>
    <td><a href="${decline}">Decline</a>
